...
//   return (
//     <>
//     <div classNameName='text-8xl font-sans'>App</div>
        ...
        <div className="flex h-20 items-center justify-between">
            ...
            <div className="md:ml-auto">
                <div className="flex space-x-2">
                    <a href="index.html" className="text-white bg-black hover:bg-gray-900 rounded-md px-3 py-2">
                        Home
                    </a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-md relative">
                <div className="p-4">
                    ...
                    <div className="mb-5">
                        We are seeking a talented Front-End Developer to join our team in Boston, MA. The ideal candi
            ...
            <div className="bg-white rounded-xl shadow-md relative">
                <div className="p-4">
                    ...
                    <div className="mb-5">
                        Join our team as a Front-End Developer in sunny Miami, FL. We are looking for a motivated indi
                        with a passion...
                    </div>
                    <h3 className="text-indigo-500 mb-2">$70K - $80K / Year</h3>
                    <div className="border border-gray-100 mb-5"></div>
            ...
            <div className="bg-white rounded-xl shadow-md relative">
                <div className="p-4">
                    ...
                    <div className="mb-5">
                        Are you passionate about front-end development? Join our team in vibrant Brooklyn, NY, and wor
